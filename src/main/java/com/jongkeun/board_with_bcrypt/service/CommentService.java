...
import com.jongkeun.board_with_bcrypt.dto.CommentRequestDto;
import com.jongkeun.board_with_bcrypt.dto.CommentResponseDto;
import com.jongkeun.board_with_bcrypt.dto.UserRequestDto;
import com.jongkeun.board_with_bcrypt.model.Comment;
import com.jongkeun.board_with_bcrypt.model.Post;
import com.jongkeun.board_with_bcrypt.model.User;
import com.jongkeun.board_with_bcrypt.repository.CommentRepository;
import com.jongkeun.board_with_bcrypt.repository.PostRepository;
import com.jongkeun.board_with_bcrypt.repository.UserRepository;
...
public class CommentService {
    ...
    public CommentResponseDto update(Long id, CommentRequestDto dto){
        ...
        if(!user.getUsername().equals(comment.getAuthor().getUsername())){
            throw new RuntimeException("다른 유저의 댓글은 수정할 수 없습니다.");
        }
